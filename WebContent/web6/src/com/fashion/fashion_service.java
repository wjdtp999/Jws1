...
public class fashion_service {
	...
	public void all_data(HttpServletRequest request) {
		...
		exchange_dao ed=new exchange_dao();
		int total=ed.select_count("fashion");
		
		ArrayList<exchange> list= ed.all_select("fashion",page_num==1? 1:(page_num-1)*10,10);
	...
	public void save(HttpServletRequest request) {
		...
		exchange_dao ed = new exchange_dao();
		ed.board_save("fashion",writer,title,cont,filename);
	}
}
